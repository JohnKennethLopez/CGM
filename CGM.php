    ...
    <section id="bg-image">
        ...
        <div class="slider">
            <div class="slides">
                ...
                <div class="img">
                    <img class="photo" src="img3.jpg" alt="">
                </div>
                <div class="img">
                    <img class="photo" src="img4.jpg" alt="">
                </div>
                <div class="img">
                    <img class="photo" src="img5.jpg" alt="">
                </div>
                <div class="auto">
        ...
        <section id="footer">
            <div class="foot1">
                <h1 class="update">To keep updated<br>Follow us on:</h1>
                    <div class="socmed">
                            <div class="fbyt">
                                <a href="https://www.facebook.com/CGMMain"><img class="footimg" src="fb.png"><p>Church of God's Miracles - Las Piñas Main</p></a>
                                <a href="https://www.youtube.com/channel/UCmrFWaixqTWQLfHWfuEJcYA/featured"><img class="footimg" src="yt.png"><p>Church of God's Miracles OFFICIAL</p></a>
                    </div>
                </div>
            </div>
            <div class="foot2">
